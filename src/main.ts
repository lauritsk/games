...
import { getResolvedAppearance, initializeAppearance, onAppearanceChange } from "./appearance";
import { createAppearanceControl, updateAppearanceControl } from "./appearance-control";
