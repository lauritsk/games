import { clearNode, el, pillButton, setSelected, type GameDefinition } from "./core";
import { formatDate } from "./game-result-format";
import type { GameResult } from "./game-results";
import { loadGamePreferences } from "./game-preferences";
import {
  fetchLeaderboard,
